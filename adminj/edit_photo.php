    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <h1>Welkom op de edit pagina</h1>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="photo-info-box">
                                ...
                                <div class="inside">
                                    <div class="box-inner">
                                        <p class="text">
                                            <span class="fas fa-calendar"></span> Uploaded on : April 01, 2020 @ 5:26
                                        </p>
                                        <p class="text">
                                            Photo Id: <span class="data photo_id_box">Uploaded on : April 01, 2020 @ 5:26</span>
                                        </p>
                                        <p class="text">
